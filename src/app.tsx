...
import type { Mode, ModeContents, Contents, Info, PayLoadStatus, JsonValue } from './types/types.js';
...
const App = () => {
    ...
    useEffect(() => {
        ...
        const manageApi = async () => {
            ...
            try {
                let bodyToSend: JsonValue | undefined = undefined;
                ...
                setContent({ body, headers: normalizedHeaders });
        ...
        <Box width="100%" justifyContent="center" paddingX={1}>
            ...
            >
                ...
                <Box flexDirection="column">
                    <Text dimColor>
                        Tab to switch • {mode.toUpperCase()} | ESC - Exit
                    </Text>
